"""
Django settings for gym_magna project.
...
SECRET_KEY = 'django-insecure-$iu+cbuctk-5hbd=o60t*39^=p-g$hp06t+sm+_m+r06bo3w+y'
...
WSGI_APPLICATION = 'gym_magna.wsgi.application'
